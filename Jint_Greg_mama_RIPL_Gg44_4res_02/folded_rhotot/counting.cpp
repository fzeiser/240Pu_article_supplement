{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.762500,7.037500,50,2.394595,326900000.000000);
   ...
   TArrow *arrow1 = new TArrow(0.437500,403.613009,0.437500,56.822937,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.737500,1098.430585,0.737500,154.643311,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.237500,462388.849591,3.237500,65097.734375,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.737500,20230264.171388,4.737500,2848131.750000,0.02,">");
   arrow4->Draw();
   c1->Update();
